...
class Constants {
  static const customButtons = [
    FloatingActionButtonCustom(
        value: 'C', color: Color.fromARGB(255, 105, 36, 36)),
    FloatingActionButtonCustom(
        value: '()', color: Color.fromARGB(255, 59, 99, 97)),
    FloatingActionButtonCustom(
        value: '%', color: Color.fromARGB(255, 59, 99, 97)),
    FloatingActionButtonCustom(
        value: '/', color: Color.fromARGB(255, 59, 99, 97)),
    ...
    FloatingActionButtonCustom(
        value: 'x', color: Color.fromARGB(255, 59, 99, 97)),
    ...
    FloatingActionButtonCustom(
        value: '+', color: Color.fromARGB(255, 59, 99, 97)),
    FloatingActionButtonCustom(
        value: '+/-', color: Color.fromARGB(255, 53, 53, 53)),
    FloatingActionButtonCustom(value: '0'),
    FloatingActionButtonCustom(value: '.'),
    FloatingActionButtonCustom(
        value: '=', color: Color.fromARGB(255, 50, 131, 127)),
  ];
}
